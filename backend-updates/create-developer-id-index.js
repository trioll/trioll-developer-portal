...
// Create Global Secondary Index for developerId
async function createDeveloperIdIndex() {
    const params = {
    ...
    try {
        console.log('Creating GSI for developerId on table:', USERS_TABLE);
